...
export default function Registration({ }: Props): ReactElement {
    ...
    return (
        <>
            <TopNav />
            <div className="min-vw-100 justify-content-center container-fluid">

                <Form>

                    <Card>
                        {/* <Card.Header> Basic Information </Card.Header> */}
                        <Card.Title className="m-2">Registration</Card.Title>
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                ...
                                <Col lg={4}>
                                    ...
                                    <Form.Group>
                                        <Form.Label>Phone No/Username*</Form.Label>
                                        <InputGroup size="sm">
                                            <FormControl className="shadow-none" type="text" aria-label="Small"
