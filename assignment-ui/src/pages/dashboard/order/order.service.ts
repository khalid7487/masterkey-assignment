import {post, get, put, del, patch} from "../../../common/http";

export const gets = (payload: any) => {
    return post("/enroll/getall", payload);
};
...
export const UpdateEnrollmentStatus = (id:any, payload:any) => {
    return patch(`/enroll/confirm-enrollement/${id}`, payload);
};
